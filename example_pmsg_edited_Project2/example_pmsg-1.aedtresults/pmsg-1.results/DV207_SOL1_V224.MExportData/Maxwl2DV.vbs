...
oDefinitionManager.ModifyLibraries designName, Array("NAME:PersonalLib"), _
  ...
  "Materials", "RMxprt"))
if (oDefinitionManager.DoesMaterialExist("M19-24G_2DSF0.950")  = False) then 
oDefinitionManager.AddMaterial Array("NAME:M19-24G_2DSF0.950", _
  ...
  , "X:=", 1591.5, "Y:=", 1.3681), Array("NAME:Coordinate", "X:=", 3183, _
  "Y:=", 1.4442), Array("NAME:Coordinate", "X:=", 4774.6, "Y:=", 1.5013), _
  Array("NAME:Coordinate", "X:=", 6366.1, "Y:=", 1.5489), Array(_
  "NAME:Coordinate", "X:=", 7957.7, "Y:=", 1.587), Array("NAME:Coordinate", _
  "X:=", 15915, "Y:=", 1.711), Array("NAME:Coordinate", "X:=", 31830, "Y:=", _
  1.807), Array("NAME:Coordinate", "X:=", 111407, "Y:=", 1.907), Array(_
  "NAME:Coordinate", "X:=", 190984, "Y:=", 2.007), Array("NAME:Coordinate", _
  "X:=", 350138, "Y:=", 2.207), Array("NAME:Coordinate", "X:=", 509292, "Y:="_
  , 2.407), Array("NAME:Coordinate", "X:=", 2.10083e+06, "Y:=", 4.407))), _
  Array("NAME:core_loss_type", "property_type:=", "ChoiceProperty", _
  "Choice:=", "Electrical Steel"), "core_loss_kh:=", 0, "core_loss_kc:=", _
  4.55322, "core_loss_ke:=", 0, "conductivity:=", 0, "mass_density:=", 7267.5_
  ) 
end if
_
  if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.000_N")  = False) then 
...
_
  if (oDefinitionManager.DoesMaterialExist("XG196/96_2DSF1.000_S")  = False) then 
...
oModule.AssignCoil Array("NAME:PhBRe_1", "Objects:=", Array("CoilRe_2"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhARe_2", "Objects:=", Array("Coil_2"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhA_2", "Objects:=", Array("CoilRe_3"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhBRe_3", "Objects:=", Array("Coil_3"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhB_3", "Objects:=", Array("CoilRe_4"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhA_4", "Objects:=", Array("Coil_4"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhARe_4", "Objects:=", Array("CoilRe_5"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
...
oModule.AssignCoil Array("NAME:PhBRe_5", "Objects:=", Array("CoilRe_6"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhC_6", "Objects:=", Array("Coil_6"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhCRe_6", "Objects:=", Array("CoilRe_7"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
...
oModule.AssignCoil Array("NAME:PhB_9", "Objects:=", Array("Coil_9"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseB")
oModule.AssignCoil Array("NAME:PhBRe_9", "Objects:=", Array("CoilRe_10"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseB")
...
oModule.AssignCoil Array("NAME:PhCRe_10", "Objects:=", Array("CoilRe_11"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhA_11", "Objects:=", Array("Coil_11"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhARe_11", "Objects:=", Array("CoilRe_12"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhCRe_12", "Objects:=", Array("Coil_12"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhC_12", "Objects:=", Array("CoilRe_13"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseC")
oModule.AssignCoil Array("NAME:PhARe_13", "Objects:=", Array("Coil_13"), _
  "Conductor number:=", "conds", "PolarityType:=", "Negative", "Winding:=", _
  "PhaseA")
oModule.AssignCoil Array("NAME:PhA_13", "Objects:=", Array("CoilRe_14"), _
  "Conductor number:=", "conds", "PolarityType:=", "Positive", "Winding:=", _
  "PhaseA")
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  ), Array("NAME:Pair", "Name:=", "Bridge", "Value:=", "0mm"), Array(_
  "NAME:Pair", "Name:=", "Rib", "Value:=", "0mm"), Array("NAME:Pair", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "XG196/96_2DSF1.000_N", "SolveInside:=", True) 
...
oModule.AssignTrueSurfOp Array("NAME:SurfApprox_Mag", "Objects:=", Array(_
  ...
  "SurfDevChoice:=", 2, "SurfDev:=", "0.03mm", "NormalDevChoice:=", 2, _
...
oEditor.Subtract Array("NAME:Selections", "Blank Parts:=", "Band,InnerRegion" & _
  ...
  ",Coil_8,Coil_9,Coil_10,Coil_11,Coil_12,Coil_13,Coil_14,CoilRe_0" & _
  ...
  ",Rotor,Mag_0,Mag_1,Mag_2,Mag_3,Mag_4,Mag_5,Mag_6,Mag_7", _
